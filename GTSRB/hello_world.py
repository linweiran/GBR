...
print ("We will demonstrate with the worst-performing strategy that we proposed (Estimate by Computing a Prior from Validation Set).")
...
print ("Benign accuracy of the targeted classes is: "+format(lresults[1], ".4f"))
...
print ("Benign accuracy of the targeted classes is :"+format(acc, ".4f"))
