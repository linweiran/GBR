...
class ProberMAX():
    ...
    def attack(self, reconstruction_sentence, answer_label, target_classes,print_info = False, _ori_sentence = None, task = None):
        ...
        adv_answer=logits.argmax(dim = 1).cpu()[0]
        """
        ...
        """
        return (True, loss) if adv_answer in target_classes else (False, loss)
