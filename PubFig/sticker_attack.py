    ...
    def exhaustive_search(self, X, y, width, height, xskip, yskip):
        ...
        for i in range(xtimes):
            for j in range(ytimes):
                ...
                output_j[all_loss > max_loss] = padding_j[all_loss > max_loss].float()
                output_i[all_loss > max_loss] = padding_i[all_loss > max_loss].float()
